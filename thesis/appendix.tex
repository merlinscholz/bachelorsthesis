...
\begin{figure}[h!]
	...
	\end{groupplot}
	\end{tikzpicture}
	\caption{Vergleich unterschiedlicher möglicher Abbruchkriterien, jeweils bis 300 Epochen. Die Legenden geben die zugehörige Marsaufnahme aus Abschnitt~\ref{sec:modifications} an.}
	\label{app:exp_stoppingcriteria}
\end{figure}