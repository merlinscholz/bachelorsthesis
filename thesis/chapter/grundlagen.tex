...
Er gibt also das Verhältnis der Veränderung der Verlustfunktion des Netzes zur Veränderung einer gewichtete Eingabe $z_j^l$ an. Dies lässt sich auch in vektorisierter Form schreiben: (nach \cite[Kap.~2]{nielsen_15})
...
Mithilfe dieser Formeln (\ref{eqn:bp1}, \ref{eqn:bp2}, \ref{eqn:bp3} und \ref{eqn:bp4}) lässt sich nun, wie für das Gradientenverfahren benötigt, effizient der Gradient der Verlustfunktion $C$ in Abhängigkeit bestimmter Parameter berechnen: (nach \cite[Kap.~2]{nielsen_15})