...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		...
		\captionsetup{format=plain}
		\subcaption{Beispiel für einen Graben}
		\label{fig:ex_graben}
	\end{subfigure}
	\caption{Beispiele für Merkmale der Marsoberfläche, alle aus \cite{greeley_13}}
\end{figure}

Die wohl signifikantesten Merkmale der Oberfläche sind \ua: \cite{greeley_13}
\begin{itemize}
