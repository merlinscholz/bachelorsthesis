...
Zur Evaluation der Resultate wird ein Algorithmus zum Vergleich von unterschiedlichen, unbenannten Clusterings benötigt. An dieser Stelle eignet sich der Adjusted Rand Index \cite{hubert_85}, er kann definiert werden durch:
