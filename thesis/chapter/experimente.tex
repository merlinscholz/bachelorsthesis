...
% TODO Wrong dataset Dort ist zu erkennen, dass die Kraterränder auf den segmentierten Aufnahmen leicht zu erkennen sind, außerdem fällt auf, dass auch die Ground Truth nicht unbedingt fehlerfrei ist: Insbesondere in Aufnahme \texttt{a)}
\begin{table}[h!]
	\setlength\tabcolsep{0pt}
	\begin{tabularx}{\textwidth}{>{\centering}m{0.05\textwidth}
			>{\centering}m{0.2375\textwidth}
