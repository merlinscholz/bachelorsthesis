...
\begin{wrapfigure}{o}{0.38\textwidth}
	\centering
	\includegraphics[width=0.37\textwidth,keepaspectratio]{images/GEN_slic_crater.png}
...
Eine geeignete Methode wird in \cite{jain_91} beschrieben: In dieser Methode wird eine Reihe von Gabor-Filtern dazu benutzt, die Textur des Bildes zu analysieren. 