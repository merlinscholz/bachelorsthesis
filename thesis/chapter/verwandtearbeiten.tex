...
Anschließend wird --~wie beim SLIC-Algorithmus~-- der k-Means-Algorithmus auf diesen Datenwürfel angewandt, es werden also Pixel mit ähnlichen Texturen in Cluster zusammengefasst.
